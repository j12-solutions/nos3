...
Several files will need to be changed (and have been changed in this branch) to go from a base NOS3 scenario, with a single spacecraft, to a constellation scenario with a lunar focus.
